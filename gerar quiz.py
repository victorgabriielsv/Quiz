...
# Monta o array de memes para o JavaScript (pega as imagens do meio da lista)
memes_js = "var MEMES = [\n"
for url in b64s[1:11]:
    memes_js += f'  "{url}",\n'
memes_js += "];"

# Estrutura do documento HTML e CSS do Quiz
html = f"""<!DOCTYPE html>
<html lang="pt-BR">
<head>
  <meta charset="UTF-8">
...
# Gera o arquivo HTML no mesmo diretório atual
